...
export default class Legend {
	...
	public update()
	{
		...
		for (let series of this.series)
		{
			...
			item.innerHTML = `<span class="chart__legend__item__circle" style="border-color:${series.config.color}"></span> 
<svg version="1.1" viewBox="0 0 512 512" xml:space="preserve" width="20px" height="20px"
     xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <path fill="white" d="M235.1,386.3c-5.7,0-11.1-2.4-14.9-6.6l-104.1-116c-7.4-8.2-6.7-20.9,1.5-28.2c8.2-7.4,20.9-6.7,28.2,1.5   l86.8,96.8l131.6-199.1c6.1-9.2,18.5-11.7,27.7-5.7c9.2,6.1,11.7,18.5,5.7,27.7L251.8,377.4c-3.4,5.2-9,8.5-15.2,8.9   C236.1,386.3,235.6,386.3,235.1,386.3z"/></svg>
 ${series.config.name}`;
